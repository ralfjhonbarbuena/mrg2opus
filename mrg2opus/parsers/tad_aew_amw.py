...
class TADAewAmwParser(BaseMRGParser):
    ...
    def _build_one_scope(self, data: ScopeData, config: MappingProfile) -> OpusRowSet:
        ...
        def _identity(key: tuple) -> tuple[str, str, int]:
            ...
            return (
                resolve_for_block(config.commodity_code_overrides, data.commodity_description, seq, block_count, data.commodity_code),
                resolve_for_block(config.commodity_description_overrides, data.commodity_description, seq, block_count, data.commodity_description),
                resolve_for_block(config.commodity_sequence_overrides, data.commodity_description, seq, block_count, seq),
            )

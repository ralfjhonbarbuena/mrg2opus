...
from mrg2opus.parsers import auec, auwc, cse, eaf, laec, lawc, nz1_sea, saf, tad_oew_omw, waf, west_asia_waf  # noqa: F401
...
ALL_LANE_IDS = {"SAF", "EAF", "CSE", "LAEC", "LAWC", "WAF", "AUEC", "AUWC", "TAD-OEW-OMW", "WEST-ASIA-WAF", "NZ1-SEA"}
SAMPLES = {
